            ...
            if ($count > 0) {
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    <div class="box-3 text_center">
                        <a href="<?php echo SITE_URL; ?>category_drinks.php?category_id=<?php echo $id; ?>"><img
                                    class="img_responsive border_radius_20"
                                    src="<?php echo SITE_URL; ?>images/category/<?php echo $image_name; ?>" alt="">
                        </a>
