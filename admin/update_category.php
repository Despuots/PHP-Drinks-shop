            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($current_image != "") {
                            ?>
                            <img src="<?php echo SITE_URL; ?>images/category/<?php echo $current_image; ?>" alt=""
                                 width="100px">
                            <?php
                        } else {
                ...
                <tr>
                    ...
                    <td>
                        <input <?php if ($featured == "Taip") {
                            echo "checked";
                        } ?> type="radio" name="featured" value="Taip"> Taip
                        <input <?php if ($featured == "Ne") {
                            echo "checked";
                        } ?> type="radio" name="featured" value="Ne"> Ne
                    </td>
                </tr>
                <tr>
                    <td>Ar aktyvus:</td>
                    <td>
                        <input <?php if ($active == "Taip") {
                            echo "checked";
                        } ?> type="radio" name="active" value="Taip"> Taip
                        <input <?php if ($active == "Ne") {
                            echo "checked";
                        } ?> type="radio" name="active" value="Ne"> Ne
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
